    ...
    <main className="max-w-2xl mx-auto px-4 py-10">
      ...
      <section className="text-center mb-10">
        <h1 className="text-2xl md:text-3xl font-bold text-[#14364f] leading-snug mb-3">
          קיבלת דרישת היטל השבחה, או מתכננים עסקה שעלולה לחייב בה?
          <br />
          בדקו מראש, לפני שמשלמים או מתחייבים.
        </h1>
        <p className="text-gray-600 max-w-xl mx-auto leading-relaxed">
          ...
          הנכס, ומה הכריע השמאי המכריע. בין אם כבר קיבלת דרישת תשלום ובין אם אתה בודק מראש לקראת
          מכירה, בנייה או עסקה, זו בדיקה ראשונית שמרכזת עבורך את ההכרעות הרלוונטיות ומבארת אותן בשפה
          פשוטה וברורה, במקום חיפוש עצמאי בעשרות רבות של מסמכים ארוכים ומסובכים במאגר הממשלתי.
        </p>
        ...
        <p className="text-sm text-gray-500 max-w-xl mx-auto mt-4 leading-relaxed">
          עדיין לא קיבלתם דרישה, אבל מתכננים למכור, לבנות או לבצע עסקה בנכס? <strong className="text-[#14364f]">אותה בדיקה מתאימה גם לכם</strong>, לבדיקה מראש של מה שעשוי לחכות לכם, לפי הכרעות קודמות באותה ועדה מקומית.
        </p>
      </section>

      <section className="grid sm:grid-cols-3 gap-4 mb-10">
        {[
          { title: "1. בוחר ועדה", body: "מזין את הוועדה המקומית הרלוונטית לנכס שלך" },
      ...
      <section className="mb-10">
        ...
        <ul className="text-sm text-gray-700 space-y-1.5 list-disc pr-5 max-w-xl mx-auto">
          <li><strong>קיבלתם כבר דרישת היטל השבחה:</strong> האם יש הצדקה לבדוק לפני שממשיכים</li>
          <li><strong>עדיין לא קיבלתם, אבל מתכננים למכור, לבנות או לבצע עסקה:</strong> בדקו מראש מה עשוי לחכות לכם, לפי הכרעות דומות בוועדה שלכם</li>
