    ...
    <main className="max-w-2xl mx-auto px-4 py-10">
      ...
      <section className="text-center mb-10">
        ...
        <p className="text-gray-600 max-w-xl mx-auto leading-relaxed">
          ...
          מכירה, בנייה או עסקה — בדיקה ראשונית שמרכזת עבורך את ההכרעות הרלוונטיות ומבארת אותן בשפה
        ...
        <p className="text-sm text-gray-500 max-w-xl mx-auto mt-4 leading-relaxed">
          עדיין לא קיבלתם דרישה, אבל מתכננים למכור, לבנות או לבצע עסקה בנכס? <strong className="text-[#14364f]">אותה בדיקה מתאימה גם לכם</strong> — לבדוק מראש מה עשוי לחכות לכם, לפי הכרעות קודמות באותה ועדה מקומית.
        </p>
      </section>
